...
function showTime(){
    ...
    let hourId = ids[0], minuteId = ids[2], secondId = ids[4];
    var session = "AM";
    var date = new Date();
...
switchBtnId.setAttribute("onmouseover", 'hoverIn()');
switchBtnId.setAttribute("onmouseout", 'hoverOut()');



function hoverIn(){
    switchBtnId.style = "background-color: rgb(181, 211, 236) "
    switchBtnId.style = "border: rgb(181, 211, 236) outset"
}
function hoverOut(){
    switchBtnId.style = "background-color: rgb(145, 185, 218)"
    switchBtnId.style = "border: rgb(145, 185, 218) inset"
}
